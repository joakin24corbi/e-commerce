...
const PrivacyPolicy = () => {
  ...
  return (
    <Container maxWidth={settings.maxWidth}>
      ...
      <p>
        <strong>Universal eEvents Live S.L.</strong> es el RESPONSABLE del tratamiento de los datos personales del USUARIO y le informa de que estos datos serán tratados de conformidad con lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril (GDPR), y la Ley Orgánica 3/2018, de 5 de diciembre (LOPDGDD).</p>
      <p>
        <br />
      </p>
      ...
      <p>
        Universal eEvents Live S.L.. C/ Santuario, 3 ofi 1 - 47002 Valladolid (Valladolid). E-mail: cesarlinares@eventos-digitales.com
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        Para más información sobre las garantías de privacidad, puedes dirigirte al RESPONSABLE a través de Universal eEvents Live S.L.. C/ Santuario, 3 ofi 1 - 47002 Valladolid (Valladolid). E-mail: cesarlinares@eventos-digitales.com
      </p>
    </Container>
  )
}
